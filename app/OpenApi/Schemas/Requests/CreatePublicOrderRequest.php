...
/** Projection of `App\Http\Requests\Orders\CreatePublicOrderRequest`. */
#[OA\Schema(
    schema: 'CreatePublicOrderRequest',
    ...
    properties: [
        new OA\Property(property: 'event_id', type: 'integer', example: 1, description: 'Must reference a published event in the current venue.'),
...
final class CreatePublicOrderRequest {}
